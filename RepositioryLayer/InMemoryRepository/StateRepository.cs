...
namespace RepositioryLayer.InMemoryRepository
{
    public class StateRepository : DataRepository<State>, IStateRepository
    {
        ...
        public void CreateInitData()
        {
            ...
            _dbContext.States.Add(new State() { Id = 5, StateName = "Player Makes Move", PreviousStateId = 4 });
            _dbContext.States.Add(new State() { Id = 6, StateName = "Game Finished", PreviousStateId = 5 });
